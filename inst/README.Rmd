...
**psychrmslab** provides helper functions for a Research Methods and Statistical Analysis lab course. It streamlines running common statistical analyses, generating APA-formatted tables, and creating interactive student worksheets — all from R and Quarto/RMarkdown.

## Installation

You can install **psychrmslab** using the [`pak`](https://pak.r-lib.org/) package, which handles both CRAN and GitHub installations seamlessly.
