...
# psychrmslab <img src="man/figures/logo.png" align="right" height="139" />

<!-- badges: start -->

<!-- badges: end -->

**psychrmslab** provides helper functions for a Research Methods and
...
You can install **psychrmslab** using the
...
``` r
pak::pak("emmarshall/psychrmslab")
```
...
``` r
# From a .tar.gz file
pak::pak("local::path/to/psychrmslab_0.1.0.tar.gz")

# From a local directory
pak::pak("local::path/to/psychrmslab")
```
