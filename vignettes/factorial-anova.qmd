...
| `factbg_table_with_comparisons()` | Table with pairwise results |
| `factbg_interaction_results()` | Interaction text |
| `factbg_main_effect_results()` | Main effect text |
