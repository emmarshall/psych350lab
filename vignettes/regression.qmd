...
create_correlation_interp_ft(reg_result)

# Regression weight interpretation table
create_regwt_interp_ft(reg_result)
```
...
create_correlation_interp_ft(RH1_reg)
create_regwt_interp_ft(RH1_reg)
```
...
| `create_correlation_interp_ft()` | Correlation interpretation table |
| `create_regwt_interp_ft()` | Regression weight interpretation table |
